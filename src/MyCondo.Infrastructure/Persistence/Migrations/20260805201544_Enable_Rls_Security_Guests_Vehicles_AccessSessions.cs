...
/// <summary>
/// Enables and forces Row-Level Security on the Slice B tenant-scoped tables, following the same
/// pattern as <c>Enable_Tenant_Row_Level_Security</c> and
/// <c>Enable_Rls_Property_Residents_Attachments</c> (see mycondo-api/.claude/skills/postgresql-rls.md).
/// </summary>
public partial class Enable_Rls_Security_Guests_Vehicles_AccessSessions : Migration
{
