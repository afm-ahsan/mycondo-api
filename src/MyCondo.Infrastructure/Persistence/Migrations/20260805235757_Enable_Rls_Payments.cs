...
/// <summary>
/// Enables and forces Row-Level Security on the Slice D tenant-scoped tables (idempotency_keys,
/// ledger_entries, ledger_postings, payments, resident_accounts), following the same pattern as
/// every prior RLS migration — see mycondo-api/.claude/skills/postgresql-rls.md.
/// </summary>
public partial class Enable_Rls_Payments : Migration
{
