...
/// <summary>
/// Enables and forces Row-Level Security on the Slice B2 tenant-scoped tables (7 tables across the
/// security and payroll schemas), following the same pattern as every prior RLS migration — see
/// mycondo-api/.claude/skills/postgresql-rls.md.
/// </summary>
public partial class Enable_Rls_Security_DomesticWorkers_ServiceProviders_Payroll_SebaVisits : Migration
{
