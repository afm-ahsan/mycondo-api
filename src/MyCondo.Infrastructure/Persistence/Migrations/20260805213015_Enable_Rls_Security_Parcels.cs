...
/// <summary>
/// Enables and forces Row-Level Security on the Slice C tenant-scoped tables (parcels,
/// parcel_custody_events), following the same pattern as every prior RLS migration — see
/// mycondo-api/.claude/skills/postgresql-rls.md.
/// </summary>
public partial class Enable_Rls_Security_Parcels : Migration
{
