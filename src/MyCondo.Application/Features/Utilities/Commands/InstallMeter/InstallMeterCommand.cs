...
public sealed record InstallMeterCommand(Guid BuildingId, string UtilityType, string MeterNumber) : IRequest<MeterDto>, IRequiresFeature, ILifecycleWriteOperation
{
