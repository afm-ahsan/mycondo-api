...
public sealed record RegisterStaffMemberCommand(string FullName, string Role, string? Phone) : IRequest<StaffMemberDto>, IRequiresFeature, ILifecycleWriteOperation
{
