...
public sealed class AddOwnerHouseholdMemberCommandValidator : AbstractValidator<AddOwnerHouseholdMemberCommand>
{
    public AddOwnerHouseholdMemberCommandValidator()
    {
