...
public sealed record GetAssignmentsForServiceProviderQuery(Guid ServiceProviderProfileId) : IRequest<List<ServiceProviderAssignmentDto>>, IRequiresFeature, ILifecycleReadOperation
{
