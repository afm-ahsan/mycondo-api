...
public sealed class CreateServiceProviderAssignmentCommandValidator : AbstractValidator<CreateServiceProviderAssignmentCommand>
{
    public CreateServiceProviderAssignmentCommandValidator()
    {
