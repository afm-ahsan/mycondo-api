...
public sealed record ExcludeStatementLineCommand(Guid BankStatementLineId, string Reason) : IRequest<BankStatementLineDto>, IRequiresFeature, ILifecycleWriteOperation
{
