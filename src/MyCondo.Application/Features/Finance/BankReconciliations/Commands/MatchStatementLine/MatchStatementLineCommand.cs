...
public sealed record MatchStatementLineCommand(Guid BankStatementLineId, Guid LedgerEntryId) : IRequest<BankStatementLineDto>, IRequiresFeature, ILifecycleWriteOperation
{
