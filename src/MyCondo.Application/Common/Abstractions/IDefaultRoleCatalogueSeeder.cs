...
/// approved 2026-07-28 — resolving <c>MASTER_BACKLOG.md</c> ID-7. Unlike <see cref="ISuperAdminBootstrapper"/>'s
/// SuperAdmin role, these are ordinary <c>Role.CreateCustom</c> roles: a tenant admin can rename,
/// deactivate, or re-grant them freely, and nothing is auto-assigned to any user — they exist so the
/// SuperAdmin has something sensible to hand out. Vendor and Guard from the sketch are deliberately
...
{
    /// <summary>
    /// Runs alongside <see cref="ISuperAdminBootstrapper.BootstrapAsync"/> at tenant-bootstrap time
