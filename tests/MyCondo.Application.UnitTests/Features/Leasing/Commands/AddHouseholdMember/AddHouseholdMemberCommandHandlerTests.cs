...
public class AddHouseholdMemberCommandHandlerTests
{
    ...
    private (OccupancyRegistration Registration, Guid TenantId) SetUpRegistration()
    {
        ...
        OccupancyRegistration registration = OccupancyRegistration.Register(
            ...
            null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, NowUtc);
    ...
    public async Task Throws_Conflict_When_Registration_Is_Rejected()
    {
        Guid tenantId = Guid.NewGuid();
        OccupancyRegistration registration = OccupancyRegistration.Register(
            tenantId, FlatId.New(), ResidentId.New(), ResidentType.Occupant, "John Doe", null, null, null,
            "1234567890", new DateOnly(1990, 1, 1), "Male", null, null, null, null, null, null, null, null, null,
            null, null, null, null, NowUtc);
