...
public class ApproveOccupancyRegistrationByOwnerCommandHandlerTests
{
    ...
    private static OccupancyRegistration SubmittedRegistration()
    {
        OccupancyRegistration registration = OccupancyRegistration.Register(
            TenantId, FlatId, ResidentId, ResidentType.Occupant, "Jane Doe", "01700000000", null,
            "jane@example.com", "1234567890", new DateOnly(1990, 1, 1), "Female", null, null, null, null, null,
            null, null, null, null, "123 Example Road, Dhaka", "John Doe", "01711111111", null, Now);
